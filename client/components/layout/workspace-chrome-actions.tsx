...
import { Bell, CheckCheck, Loader2, Search, Ticket } from "lucide-react";
...
export function WorkspaceChromeActions({
  ...
  const iconButtonClass =
    "flex size-8 shrink-0 items-center justify-center rounded-lg text-muted-foreground transition-colors hover:bg-black/[0.05] hover:text-foreground";
      ...
      >
        ...
        <div className="relative" data-notifications-root>
          ...
          >
            ...
            {unreadCount > 0 ? (
              <span className="absolute right-1.5 top-1.5 size-2 rounded-full border-2 border-sidebar bg-primary" />
            ) : null}
          </button>

          {notificationsOpen ? (
            <div className="absolute bottom-full left-0 z-50 mb-2 w-80 overflow-hidden rounded-lg border border-border/80 bg-popover text-popover-foreground shadow-lg ring-1 ring-foreground/10">
